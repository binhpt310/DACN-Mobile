...
public class trangchu2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView trang_chu = findViewById(R.id.test_txt_trang_thu);
        ...
        trang_chu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(trangchu2.this, thi_tracnghiem.class);
                startActivity(intent);
            }
        });
    }
